...
inline fun <E : RealmModel, reified T> RealmQuery<E>.sort(
    ...
    return when (T::class) {
        ...
        Byte::class -> this.sort(formattedFields, sortOrder)
        ByteArray::class -> this.sort(formattedFields, sortOrder)
        Short::class -> this.sort(formattedFields, sortOrder)
        Int::class -> this.sort(formattedFields, sortOrder)
        Long::class -> this.sort(formattedFields, sortOrder)
        Double::class -> this.sort(formattedFields, sortOrder)
        Float::class -> this.sort(formattedFields, sortOrder)
        Boolean::class -> this.sort(formattedFields, sortOrder)
        Date::class -> this.sort(formattedFields, sortOrder)
