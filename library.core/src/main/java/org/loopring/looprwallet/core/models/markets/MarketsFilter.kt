...
import org.loopring.looprwallet.core.models.markets.MarketsFilter.Companion.CHANGE_PERIOD_1D
import org.loopring.looprwallet.core.models.markets.MarketsFilter.Companion.SORT_BY_ARRAY_UI
import org.loopring.looprwallet.core.models.markets.MarketsFilter.Companion.SORT_BY_ARRAY_VALUES
 ...
 */
data class MarketsFilter(val ticker: String? = null, val isFavorites: Boolean, val sortBy: String, val changePeriod: String) {
