...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    companion object {
         ...
         * new value. This value is effectively static, because the activity holds a weak reference
         * to it. For more information, see [here](https://developer.android.com/guide/topics/ui/settings.html).
         */
    ...
    override fun onIsMultiPane(): Boolean {
        return ViewUtility.isXLargeTablet()
    }
